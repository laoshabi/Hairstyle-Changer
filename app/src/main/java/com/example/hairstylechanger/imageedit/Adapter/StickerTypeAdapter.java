package com.example.hairstylechanger.imageedit.Adapter;
...
public class StickerTypeAdapter extends RecyclerView.Adapter<ViewHolder> {
    public static final String[] stickerPath = {"Hairstyles/Male", "Hairstyles/Female"};
    public static final String[] stickerPathName = {"Male", "Female", };
